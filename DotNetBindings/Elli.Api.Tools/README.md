# Elli.Api.Tools - the C# library for the Tools
...
```
nuget pack -Build -OutputDirectory out Elli.Api.Tools.csproj
```
...
------------ | ------------- | ------------- | -------------
*LoanCalculatorApi* | [**CalculateLoan**](docs/LoanCalculatorApi.md#calculateloan) | **POST** /encompass/v1/calculators/loan | Get the effect of calculations applied on a loan
...
## Documentation for Models
 ...
 - [Model.LoanCalculationRequest](docs/LoanCalculationRequest.md)
