...
------------ | ------------- | ------------- | -------------
*AusTrackingLogApi* | [**CreateAusTrackingLog**](docs/AusTrackingLogApi.md#createaustrackinglog) | **POST** /encompass/v1/loans/{loanId}/ausTrackingLogs | Create AUS Tracking Log
*AusTrackingLogApi* | [**GetAusTrackingLog**](docs/AusTrackingLogApi.md#getaustrackinglog) | **GET** /encompass/v1/loans/{loanId}/ausTrackingLogs/{logId} | Retrieve AUS Tracking Log
*AusTrackingLogApi* | [**GetAusTrackingLogSnapshot**](docs/AusTrackingLogApi.md#getaustrackinglogsnapshot) | **GET** /encompass/v1/loans/{loanId}/ausTrackingLogs/{logId}/snapshot | Retrieve AUS Tracking Log Snapshot
*AusTrackingLogApi* | [**GetAusTrackingLogs**](docs/AusTrackingLogApi.md#getaustrackinglogs) | **GET** /encompass/v1/loans/{loanId}/ausTrackingLogs | Retrieve AUS Tracking Logs
*AusTrackingLogApi* | [**UpdateAusTrackingLog**](docs/AusTrackingLogApi.md#updateaustrackinglog) | **PATCH** /encompass/v1/loans/{loanId}/ausTrackingLogs/{logId} | Update AUS Tracking Log
...
*ConversationLogApi* | [**GetConversationLog**](docs/ConversationLogApi.md#getconversationlog) | **GET** /encompass/v1/loans/{loanId}/conversationLogs/{logId} | Get specific Conversation log
*ConversationLogApi* | [**GetConversationLogs**](docs/ConversationLogApi.md#getconversationlogs) | **GET** /encompass/v1/loans/{loanId}/conversationLogs | Get list of Conversation logs
